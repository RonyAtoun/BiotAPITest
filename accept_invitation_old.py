...
def get_user_token_and_id():
    def invitation_token(user_email):
        headers = {
        ...
        for attempt in range(MAX_RETRIES):
            ...
            return "Error: Number of attempts to retrieve email has been used. No email found."
...
def test_accept_invitation(get_user_token_and_id):
    ...
    token, entity_id, user_email = get_user_token_and_id(user_email)
