...
def test_identified_self_signup():
    ...
    create_registration_code_response = create_registration_code(auth_token, template_name, str(uuid.uuid4()))
    ...
    create_device_response_code = create_device(auth_token, device_template_name, device_id, registration_code_id)
